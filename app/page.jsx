  ...
  return (
    <>
      ...
      <main className="main" style={{overflowX: "hidden"}}>
        <section className="presentacion" style={{overflowX: "hidden"}}>
          <article className="first-container" style={{overflowX: "hidden"}}>
            ...
            <div className="context-image">
              <img src="./images/Pamela.jpg" alt="Pamela" data-aos="fade-left"  style={{overflowX: "hidden"}}/>
            </div>
          </article>
        </section>
        <section>
          <article className="formacion-academica">
            ...
            <div className="formacion-medica">
              <h4>Médica (U.A.I).</h4>
              <ul>
                <li>-Curso Superior de Posgrado en la Construcción del Diagnostico en Salud Mental. (A.N.A).</li>
                <li>-Curso Superior de Posgrado en Psico-Neurofarmacología. (A.N.A).</li>
                <li>-Curso Superior de Posgrado en Terapia Cognitivo Conductual en Adultos. (A.N.A).</li>
              </ul>
            </div>
          </article>
        </section>
        <section className="formaciones-especificas">
          <div className={aberturaDePsiquiatriaCursos ? 'cursos cursos-psiquiatria cursos-abiertos' : 'cursos cursos-psiquiatria'}>
          ...
          <div className="cursos cursos-medicina medicina" style={{ maxHeight: aberturaDeMedicinaCursos ? '600px' : '30px' }}>
          ...
          <div className="cursos cursos-holisteria holisteria" style={{ maxHeight: aberturaDeHolisticaCursos ? '300px' : '30px' }}>
          ...
          <div className="cursos cursos-estetica estetica" style={{ maxHeight: aberturaDeEsteticaCursos ? '550px' : '30px' }}>
        ...
        <h2 className="text-center m-10 text-3xl font-bold text-black italic">Tratamientos</h2>
        <section className="tratamientos-especificos">
          <div className="tratamiento tratamiento-psicoterapia" style={{ maxHeight: aberturaDeTratamientoPsicoterapico ? '400px' : '30px' }} onClick={() => setAberturaDeTratamientoPsicoterapico(!aberturaDeTratamientoPsicoterapico)}>
          ...
          <div className="tratamiento tratamiento-psiquiatria" style={{ maxHeight: aberturaDeTratamientoPsiquiatrico ? '1320px' : '30px' }} onClick={() => setAberturaDeTratamientoPsiquiatrico(!aberturaDeTratamientoPsiquiatrico)}>
        ...
        <section className="seccion-de-contacto">
          <section className="contacto-whatsapp">
            <h2 className="text-center m-10 text-3xl font-bold">¡Contactame!</h2>
            <div>
